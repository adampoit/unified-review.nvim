...
test('pi /review hands the terminal to Neovim and returns cleanly', async ({ terminal }) => {
	...
	await expect(terminal.getByText(/Neovim did not export a review/g)).toBeVisible();
});
