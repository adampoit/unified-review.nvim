...
export function writeRepoFiles(root: string, files: Record<string, string[] | null>) {
...
export async function waitForBuffer(terminal: Terminal, predicate: (rows: string[]) => boolean) {
