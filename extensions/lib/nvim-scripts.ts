...
export function buildReviewExportInit(reviewPath: string, diagnosticsPath: string): string {
	return (
		[
...
export function buildContextInit(path: string, target: unknown, diagnosticsPath?: string): string {
	return [
...
export function buildImportInit(feedbackPath: string, diagnosticsPath: string, target: unknown): string {
	return [
